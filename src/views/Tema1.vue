      ...
      .row.align-items-center(data-aos="fade-left")
        ...
        .col-12.col-md-12.col-lg-8
          ...
          .cajon.bg-color-primario-p10.p-4.mb-4
            p.mb-0 <b>Por ejemplo</b>, una empresa de telecomunicaciones puede externalizar su servicio de atención al cliente para enfocarse en innovación tecnológica; el proveedor BPO se encarga de gestionar llamadas, correos y chats, siguiendo protocolos definidos por el cliente, este modelo permite flexibilidad, escalabilidad y control de calidad, siempre que se establezcan indicadores claros y acuerdos de nivel de servicio (SLA).
      ...
      .container.mb-1
        .row.align-items-center(data-aos="fade-left")
          ...
          TabsB.color-primario
            .py-4.py-md-5(titulo="<em>Front office</em>" :icono="require('@/assets/curso/temas/tema1/img06.svg')")
            ...
            .py-4.py-md-5(titulo="<em>Back office</em>" :icono="require('@/assets/curso/temas/tema1/img07.svg')")
              .row.align-items-center
                .col-12.col-sm-12.col-md-8.col-lg-3.mx-auto
                  figure
          ...
          .col-12.col-md-12.col-lg-7
            .bloque-texto-b.color-terciario
              .bloque-texto-b__texto
                i.fas.fa-quote-left
                p.mb-0.ps-3 
                  b Según ESIC Business & Marketing School (2025), 
